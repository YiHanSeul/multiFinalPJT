...
<body>
	...
	<div id="selectbar">
		...
		&nbsp;&nbsp;&nbsp;
		<div id="radio-box">
			<input type="radio" name="t" id="t" onclick="care(1);"> <label
				for="t">맡아주는 병원</label> <input type="radio" name="t" id="f"
				onclick="care(0);"> <label for="f">일반 병원</label> <input
				type="radio" name="t" id="all" onclick="care(2);" checked="checked">
