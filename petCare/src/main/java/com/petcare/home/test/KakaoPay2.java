 ...
 * @Service
 * 
 * @Log public class KakaoPay2 {
 * 
 * private static final String HOST = "https://kapi.kakao.com";
 * 
 * private KakaoPayReadyVO kakaoPayReadyVO; private KakaoPayApprovalVO
 * kakaoPayApprovalVO;
 * 
 * 
 * 
 ...
 * "3f45ee9b6332b0c80a314c5b4f9ebfb7"); headers.add("Accept",
 ...
 * params.add("partner_order_id", "2"); params.add("partner_user_id", "gorany");
 * params.add("item_name", "소형견2"); params.add("quantity", "1");
 * params.add("total_amount", "45170"); params.add("tax_free_amount", "100");
 ...
 * 
 * try { kakaoPayReadyVO = restTemplate.postForObject(new URI(HOST +
 ...
 * "2"); params.add("partner_user_id", "gorany"); params.add("pg_token",
 * pg_token); params.add("total_amount", "45170");
 * 
 * HttpEntity<MultiValueMap<String, String>> body = new
 * HttpEntity<MultiValueMap<String, String>>(params, headers);
 * 
